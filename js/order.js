document.addEventListener("DOMContentLoaded", () => {
    // 1. Read from the single, unified cart key.
    // This will contain all items (cakes, sweets, ice cream)
    ...
    document.getElementById("checkoutBtn").addEventListener("click", () => {
        ...
        if (loggedIn) {
            console.log("Order confirmed! Thank you.");
            
            // Clear the unified cart on checkout.
            localStorage.removeItem("customerCart");
            cart = []; // Also clear the in-memory array
            
            window.location.href = "order.html"; // back to shop
        } else {
